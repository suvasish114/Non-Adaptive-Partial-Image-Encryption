# This script contains some general mathematical calculations and conversions
# Authors : suvasish das (https://github.com/suvasish114)
#           samrat mytra (https://github.com/samrat-p)
